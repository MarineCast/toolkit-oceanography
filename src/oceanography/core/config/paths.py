...
def project_root() -> Path:
    """Return the data workspace selected by OCEANOGRAPHY_WORKSPACE or the caller."""
    import os

    return Path(os.environ.get("OCEANOGRAPHY_WORKSPACE", Path.cwd())).expanduser().resolve()
